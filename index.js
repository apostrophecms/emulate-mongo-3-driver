...
// const connect = (url, rawOptions) => {
//   if (!url) {
//     return originalConnect();
//   }
//
//   const { useUnifiedTopology, useNewUrlParser, ...options } = rawOptions || {};
...
// MongoClient.connect = function(uri, rawOptions = {}, callback) {
//   // if ((!callback) && ((typeof options) === 'function')) {
//   //   callback = options;
//   //   options = {};
//   // }
//   const { useUnifiedTopology, useNewUrlParser, ...options } = rawOptions || {};
//   console.log({ rawOptions, options });
